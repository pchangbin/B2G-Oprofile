...
set_tv_header (struct ld_plugin_tv *tv)
{
  ...
  /* Version info.  */
  static const unsigned int _major = (unsigned)(BFD_VERSION / 100000000UL);
  static const unsigned int _minor = (unsigned)(BFD_VERSION / 1000000UL) % 100;
